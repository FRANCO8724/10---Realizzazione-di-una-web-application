...
<body>
    ...
    <div id="Add_membro" class="form-container" style="display: none;">
        ...
        <form method="POST">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'Attore_azione') {
                ...
                // Crea una query per inserire i dati nella tabella "cast2"
                $sql = "INSERT INTO cast2 (Nome, Cognome, Data_di_nascita) VALUES ('$Nome', '$Cognome', '$Data_di_nascita')";
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'Attore_azione') {
                ...
                $nome_film = $_POST['film'];
                  ...
                  $query = "SELECT CODICE FROM cast2 WHERE Nome = '$nome_attore' LIMIT 1";
                  // Esegui la query
    ...
    <div id="Add_biografia" class="form-container" style="display: none;">
        ...
        $query = "
                 ...
                 FROM cast2
                 JOIN vita ON cast2.CODICE = vita.ID
        ";
